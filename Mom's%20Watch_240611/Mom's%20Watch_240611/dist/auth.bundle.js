...
function registerUser(email, password) {
  (0,firebase_auth__WEBPACK_IMPORTED_MODULE_1__.createUserWithEmailAndPassword)(auth, email, password).then(function (userCredential) {
...
function displayUserInfo(email) {
  ...
  if (userInfo) {
    userInfo.textContent = "Logged in as: ".concat(email);
