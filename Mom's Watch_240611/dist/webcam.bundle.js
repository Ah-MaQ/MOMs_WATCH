...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function _startWebcam() {
    _startWebcam = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var sendFrame, stream, canvas, context;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            console.error('Error accessing the webcam:', _context2.t0);
          case 15:
          case "end":
  ...
  pipButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  ...
  popupButton.addEventListener('click', function () {
    ...
    var popupVideo = popup.document.getElementById('popupWebcam');
